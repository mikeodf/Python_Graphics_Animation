"""
Program name: legs_walking_single stride_1.py
Objective: Animate a rudimentary walking stride.

Keywords: canvas, legs, walking, single stride
============================================================================79 
