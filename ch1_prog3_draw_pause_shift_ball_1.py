""" 
Program name: draw_pause_shift_ball_1.py
Objective: Re-draw a ball in  a timed sequence of positions.

Keywords: canvas, ball, shift, time
============================================================================79
...
cycle_period = 500 # Time between fresh positions of the ball (milliseconds).
...
for i in range(1,10):       # end the program after 10 position shifts. 
    ...
    chart_1.after(cycle_period)   # This makes execution pause for 500 milliseconds.
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
